...
#define HTTP_VERSION_NOT_SUPPORTE_HTML = "<html><head><title>505 HTTP Version Not Supported</title></head><body><center><h1>505 HTTP Version Not Supported</h1></center><hr><center>nginx/1.27.2</center></body></html>"
